...
<html lang="en">
<head>
    <title>Code coverage report for src/token/Token.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/token</a> Token.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ATHENZ_TOKEN_MAX_EXPIRY = (Number(config.tokenMaxExpiry) &gt; 30 * 24 * 60 * 60) ? <span class="branch-0 cbranch-no" title="branch not covered" >30 * 24 * 60 * 60 </span>: Number(config.tokenMaxExpiry);
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this._expiryTime !== 0 || <span class="branch-1 cbranch-no" title="branch not covered" >!ATHENZ_TOKEN_NO_EXPIRY </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >!allowNoExpiry)</span> {
