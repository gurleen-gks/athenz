...
<html lang="en">
<head>
    <title>Code coverage report for src/impl/RoleAuthority.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/impl</a> RoleAuthority.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    this._keyStore = null;
    this._allowedOffset = (ATHENZ_PROP_TOKEN_OFFSET) ? Number(ATHENZ_PROP_TOKEN_OFFSET) : <span class="branch-1 cbranch-no" title="branch not covered" >300;</span>
    this._userDomain = ATHENZ_PROP_USER_DOMAIN || <span class="branch-1 cbranch-no" title="branch not covered" >'user';</span>
    this._headerName = ATHENZ_PROP_ROLE_HEADER || <span class="branch-1 cbranch-no" title="branch not covered" >'Athenz-Role-Auth';</span>
&nbsp;
    // case of invalid value, we'll default back to 5 minutes
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this._allowedOffset &lt; 0) {
<span class="cstat-no" title="statement not covered" >      this._allowedOffset = 300;</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  st</span>atic setConfig(c) {
<span class="cstat-no" title="statement not covered" >    config = Object.assign({}, config, c.auth_core);</span>
<span class="cstat-no" title="statement not covered" >    RoleToken.setConfig(c);</span>
<span class="cstat-no" title="statement not covered" >    SimplePrincipal.setConfig(c);</span>
  }
&nbsp;
  initialize() {
  }
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (tokenPrincipal.substring(0, idx).toLowerCase() === this._userDomain) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Mon Aug 20 2018 13:45:54 GMT-0700 (PDT)
</div>
</div>
