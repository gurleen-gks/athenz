...
<html lang="en">
<head>
    <title>Code coverage report for src/impl/SimplePrincipal.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/impl</a> SimplePrincipal.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    if (domain) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (authority.getDomain()) {
        winston.warn('domain mismatch for user ' + name + ' in authority + ' + authority);
        return null;
      }
    }
