...
<html lang="en">
<head>
    <title>Code coverage report for src/token/RoleToken.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/token</a> RoleToken.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >    super.setConfig(c);</span>
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (kv.length === 2) {
        switch (kv[0]) {
          case 'a':
            ...
            break;
          case 'c':
            <span class="missing-if-branch" title="else path not taken" >E</span>if (Number(kv[1]) === 1) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this._principal) {
      parts.push("p=" + this._principal);
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this._host) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this._ip) {
