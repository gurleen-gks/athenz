...
<html lang="en">
<head>
    <title>Code coverage report for src/impl/SimpleServiceIdentityProvider.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/impl</a> SimpleServiceIdentityProvider.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >    PrincipalAuthority.setConfig(c);</span>
<span class="cstat-no" title="statement not covered" >    PrincipalToken.setConfig(c);</span>
...
<span class="cstat-no" title="statement not covered" >      urlhost = 'localhost';</span>
    }
&nbsp;
    return urlhost;
  }
