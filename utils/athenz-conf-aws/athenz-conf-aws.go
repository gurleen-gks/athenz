...
func usage() string {
	...
	buf.WriteString("usage: athenz-conf -z <zms_url> -k <zms public key> -t <zts_url> -e <zts public key>")
...
func main() {
	...
	if zmsUrl == "" ||  ztsUrl == "" || zmsPublicKey == "" || ztsPublicKey == ""{
		fmt.Println(usage())
		log.Fatalf("All flags are mandatory")
	}
